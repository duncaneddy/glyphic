...
<template>
  <SectionCard title="Image">
    <div class="flex items-center gap-2">
      <label class="cursor-pointer rounded border border-gray-300 px-3 py-1.5 text-sm hover:bg-gray-100 dark:border-[#4a4a4a] dark:hover:bg-[#333333]">
        Upload image…
    ...
    <template v-if="editor.config.style.logo">
      ...
      <label v-if="editor.config.style.logo.knockout" class="flex items-center gap-2 pl-6 text-sm">
        <select v-model="editor.config.style.logo.knockoutMode" class="rounded border border-gray-300 px-2 py-1 text-xs dark:border-[#4a4a4a] dark:bg-[#333333] dark:text-neutral-100">
    ...
    <label class="flex items-center gap-2 border-t border-gray-100 pt-3 text-sm dark:border-[#3a3a3a]">
      Error correction
      <select v-model="editor.config.style.ecLevel" class="rounded border border-gray-300 px-2 py-1 dark:border-[#4a4a4a] dark:bg-[#333333] dark:text-neutral-100">
