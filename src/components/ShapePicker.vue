...
<template>
  <div>
    <p class="mb-1 text-xs font-medium text-gray-500 dark:text-gray-400">{{ label }}</p>
    <div class="grid grid-cols-4 gap-1">
      <button v-for="opt in options" :key="opt" :title="opt"
        ...
        :class="opt === modelValue
          ? 'border-gray-900 bg-gray-900 text-white dark:border-gray-100 dark:bg-gray-100 dark:text-gray-900' : 'border-gray-200 text-gray-600 hover:bg-gray-100 dark:border-gray-800 dark:text-gray-400 dark:hover:bg-gray-800'"
